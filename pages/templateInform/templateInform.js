...
Page({
        ...
        if (status == 1) {
          ...
          if (res.data.data.temp_id==301){
              wx.request({
                ...
                method: "GET",
                success: function (res) {
                  //console.log("照片可上传位置301:", res);
                  //console.log("照片可上传位置301:", res.data.data);
  ...
  xingzuo(e){
    ...
    console.log('position1:', position1, 'rol:', rol, 'index:', index, 'allPosition:',allPosition);
    ...
    allPosition[index]= '-1' ;
    console.log('allPosition[index]:',allPosition[index]);
    that.setData({
      position1: position1,
      allPosition: allPosition
    })
